...
#for pfeast a aout because anonymous
mpiifx -o a.out -module build/ src/utils.f90 src/tests_module.f90 src/spin.f90 src/main_pfeast.f90 -L$FEASTROOT -lpfeast -qmkl=parallel -qopenmp -lmkl_blacs_intelmpi_lp64 -liomp5 -lpthread -lm -ldl
