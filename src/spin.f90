module heisenberg 
    ...
    subroutine Hamiltonian_fill_open_mp(N_spin, J_spin, Sz_subspace_size, hash_Sz, ia, ja, val_arr)
        ...
        character(len=53) :: file_name1, file_name2  
        type(timer) :: calc_timer
        ...
        write(file_name1, '(A,I0,A)') 'ia_', N_spin, '_feast.dat'
        write(file_name2, '(A,I0,A)') 'ja_val_arr_', N_spin, '_feast.dat'
        open(10, file=trim(file_name1), recl = 512)
        open(11, file=trim(file_name2), recl = 512)
        ...
        write(*,*) 'ja and val_arr saving:'
        do ind_3 = 1, ja_val_arr_size
            !write(*,*) ind_3, ja(ind_3), val_arr(ind_3)
            write(11,*) ja(ind_3), val_arr(ind_3)
        end do
        ...
        subroutine Hamiltonian_diag_feast(N_spin, J_spin, Sz_subspace_size, ia, ja, val_arr)
            use omp_lib
            use mkl_vsl
            use math_functions
            use timing_utilities
        ...
        end subroutine Hamiltonian_diag_feast


!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !!!!!!!!!!!!THIS BELOW IS MPI REDISTRIBUTION OF HAMILTONIAN MATRIX FOR MULTI-NODE DIAGONALIZATION!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
